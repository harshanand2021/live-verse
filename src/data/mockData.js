...
export const mockRooms = [
  { id:'r-101', title:'Interstellar \u2014 Director\u2019s Watch', contentType:CONTENT_TYPES.MOVIE,       visibility:ROOM_VISIBILITY.PUBLIC,  status:ROOM_STATUS.LIVE,      hostName:'Harsh Anand',   hostId:'u-002', viewerCount:248,  posterColor:'#1B2A4A', description:'Wormholes, watches, and a whole lot of crying.', code:null,      startedAt:'21 minutes ago' },
  { id:'r-102', title:'The Last Stand \u2014 S2 Finale',          contentType:CONTENT_TYPES.SERIES,      visibility:ROOM_VISIBILITY.PUBLIC,  status:ROOM_STATUS.LIVE,      hostName:'Ankita Singh',  hostId:'u-005', viewerCount:132,  posterColor:'#4A1B2A', description:'Season finale watch party. No spoilers.',       code:null,      startedAt:'8 minutes ago'  },
  { id:'r-103', title:'IPL Final \u2014 Live Watch Party',         contentType:CONTENT_TYPES.LIVE_EVENT, visibility:ROOM_VISIBILITY.PUBLIC,  status:ROOM_STATUS.LIVE,      hostName:'Anushka Roy',  hostId:'u-003', viewerCount:1204, posterColor:'#1B4A2A', description:'Every six gets a chat explosion.',              code:null,      startedAt:'1 hour ago'     },
  { id:'r-104', title:'Midnight Animation Marathon',               contentType:CONTENT_TYPES.MOVIE,       visibility:ROOM_VISIBILITY.PRIVATE, status:ROOM_STATUS.LIVE,      hostName:'Kanishk Panwar', hostId:'u-001', viewerCount:32,   posterColor:'#3A1B4A', description:'Friends-only. Three films, zero sleep.',        code:'MOON-42', startedAt:'34 minutes ago' },
  { id:'r-105', title:'Indie Sundays: Short Films Vol. 4',         contentType:CONTENT_TYPES.MOVIE,       visibility:ROOM_VISIBILITY.PUBLIC,  status:ROOM_STATUS.SCHEDULED, hostName:'Manas Bagalia',   hostId:'u-004', viewerCount:0,    posterColor:'#4A3A1B', description:'Curated indie shorts with director Q&A.',       code:null,      startedAt:'Starts in 2 hours' },
