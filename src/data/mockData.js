...
// 'you' status is assigned dynamically at runtime when a viewer picks a seat —
// no seat is pre-seeded with it here.
...
export const mockRooms = [
  {
    ...
    hostName: "Harsh Anand",
    hostId: "u-002",
    viewerCount: 248,
    posterColor: "#1B2A4A",
    description: "Wormholes, watches, and a whole lot of crying.",
    code: null,
  ...
  },
  {
    ...
    visibility: ROOM_VISIBILITY.PUBLIC,
    status: ROOM_STATUS.LIVE,
    hostName: "Ankita Singh",
    hostId: "u-005",
    viewerCount: 132,
    posterColor: "#4A1B2A",
    description: "Season finale watch party. No spoilers.",
    code: null,
  ...
  },
  {
    ...
    visibility: ROOM_VISIBILITY.PUBLIC,
    status: ROOM_STATUS.LIVE,
    hostName: "Anushka Roy",
    hostId: "u-003",
    viewerCount: 1204,
    posterColor: "#1B4A2A",
    description: "Every six gets a chat explosion.",
    code: null,
  ...
  },
  {
    ...
    viewerCount: 0,
    posterColor: "#4A3A1B",
    description: "Curated indie shorts with director Q&A.",
    code: null,
  ...
  },
  {
    ...
    viewerCount: 0,
    posterColor: "#1B3A4A",
    description: "Members-only, invite code in our group chat.",
    code: "PAGE-09",
...
export const mockChatMessages = [
  {
    id: "m1",
    userId: "u-002",
    text: "okay this opening scene already hits different on a big screen",
    time: "21:02",
  },
  {
    id: "m2",
    userId: "u-003",
    text: "wait did everyone's stream just buffer or just mine",
    time: "21:03",
  },
  {
    id: "m3",
    userId: "u-004",
    text: "mine's fine, might be your wifi rohan",
    time: "21:03",
  },
  ...
  { id: "m5", userId: "u-005", text: "shhh its starting", time: "21:04" },
  {
    id: "m6",
    userId: "u-006",
    text: "the score in this scene is so good",
    time: "21:06",
  },
];
